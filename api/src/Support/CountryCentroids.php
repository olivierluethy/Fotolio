 ...
 * Server-side twin of dashboard/src/lib/countryCentroids.js: lets GeoIpService
 * resolve a country-only lookup (or a country code) to a plottable coordinate
 * for the analytics globe, with no external calls. Visual centres, marker-grade.
 */
